...
export function Lekcijas() {
  ...
  return (
    <section id="lekcijas" className="py-20 px-4 max-w-7xl mx-auto">
      <div className="flex flex-col items-center text-center mb-10">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold">Lekciju grafiks</h2>
      </div>

      <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,0.85fr)_minmax(0,1.35fr)] lg:items-start">
        ...
        <div>
          <figure className="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
            <Image
              src="/images/lecture-test-board.jpg"
              alt="Tāfele ar uzrakstu Test kā noskaņas attēls lekciju un pārbaudes darbu sadaļai"
              width={1920}
              height={1435}
